<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:db="http://docbook.org/ns/docbook" xmlns="http://www.w3.org/1999/xhtml" xmlns:epub="http://www.idpf.org/2007/ops"  xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:exsl="http://exslt.org/common" xmlns:mml="http://www.w3.org/1998/Math/MathML" extension-element-prefixes="exsl" version="2.0"  xpath-default-namespace="http://www.w3.org/1999/xhtml" exclude-result-prefixes="db xlink exsl mml #default">
	...
	<xsl:template match="db:bibliography[ancestor::db:chapter or ancestor::db:preface]">
	...
	<xsl:template match="db:bibliography[not (ancestor::db:chapter)]/db:title">
		<h2 id="{./parent::db:bibliography/@xml:id}" class="H1">
			<xsl:apply-templates/>
		</h2>
	</xsl:template>
	...
	<xsl:template match="/">
		<xsl:apply-templates/>
		<xsl:if test="descendant::db:footnote[@role='end-bk1-note']">
			<xsl:result-document href="{translate($bid,'-','')}/OEBPS/xhtml/notes.xhtml" method="xml" indent="yes" use-character-maps="hex">				
				...
				<html xmlns="http://www.w3.org/1999/xhtml" xmlns:epub="http://www.idpf.org/2007/ops" xml:lang="en" lang="en">
					...
					<body epub:type="backmatter">																		
						<section epub:type="notes">
												
							<h1 id="notes" class="FMT">Notes</h1>
						<xsl:for-each select="descendant::db:chapter|descendant::db:appendix">
							<xsl:if test="@label">
								<p class="CN">Chapter <xsl:value-of select="@label"/>
								</p>
							</xsl:if>
							<xsl:apply-templates select="descendant::db:footnote[@role='end-bk1-note']/db:para|descendant::db:footnote[@role='end-bk1-note']/db:bibliolist/db:bibliomixed|descendant::db:footnote[@role='end-bk1-note']/db:blockquote/db:para" mode="note"/>
						</xsl:for-each>
						</section>
					</body>
				</html>			
...
text-decoration : line-through;
		...
		<xsl:result-document href="{translate($bid,'-','')}/OEBPS/xhtml/cover.xhtml" method="xml" indent="yes">
			...
			<html xmlns="http://www.w3.org/1999/xhtml" xmlns:epub="http://www.idpf.org/2007/ops" xml:lang="en" lang="en">
				...
				<body epub:type="cover" id="cover-page">
					<img id="cover-image" role="doc-cover" src="../images/cover.jpg" alt="Cover: {./db:book/db:info/db:title}, Edited by {./db:book/db:info/db:info/db:authorgroup}, published by {./db:book/db:info/db:bibliomisc[@role='imprint']}"/>
				</body>
			</html>
		</xsl:result-document>
			...
			<html xmlns="http://www.w3.org/1999/xhtml" xmlns:epub="http://www.idpf.org/2007/ops" xml:lang="en" lang="en">
				...
				<body epub:type="backmatter">
					<section epub:type="index" role="doc-index">
						<h1 id="index" class="FMT"><xsl:apply-templates select=".//db:index/db:info/db:title/processing-instruction('page')"/>Index</h1>
						<ul class="none" epub:type="index-entry-list">
							<xsl:apply-templates select="descendant::db:indexterm" mode="index"/>
						</ul>
					</section>
				</body>
			</html>			
		...
		<xsl:result-document href="{translate($bid,'-','')}/OEBPS/xhtml/toc.xhtml" method="xml" indent="yes" use-character-maps="hex">
			...
			<html xmlns="http://www.w3.org/1999/xhtml" xmlns:epub="http://www.idpf.org/2007/ops" xml:lang="en" lang="en">
				...
				<body epub:type="frontmatter">
					<nav xmlns:epub="http://www.idpf.org/2007/ops" epub:type="toc" id="toc" role="doc-toc"  aria-label="table of contents">
						<ol class="CT-TOC1">
							<li>
					...
					<nav epub:type="landmarks" hidden="" aria-labelledby="hx">
						<h2 id="hx">Landmarks</h2>
						<ol class="none">
							<li>
								<a epub:type="cover" href="cover.xhtml#cover-page">Cover</a>
							</li>
							<li>
								<a epub:type="halftitlepage" href="halftitle.xhtml#half_1">Half-Title</a>
							</li>
							<xsl:if test="//db:cover">
								<li>
									<a  epub:type="frontmatter" href="series.xhtml#series_1">Series</a>
								</li>
							</xsl:if>
							<li>
								<a  epub:type="titlepage" href="title.xhtml#title_1">Title</a>
							</li>
							<li>
								<a  epub:type="copyright-page" href="copyright.xhtml#copy">Copyright</a>
							</li>
							<li>
								<a  epub:type="toc" href="contents.xhtml#re_contents">Contents</a>
							</li>
							
							<xsl:if test="//db:dedication">
								<li>
									<a  epub:type="dedication" href="dedication.xhtml#ded">Dedication</a>
								</li>
							</xsl:if>
							
							<xsl:for-each select="//db:preface|//db:acknowledgements|db:abbreviation">
								<li>
									<a  epub:type="frontmatter" href="{substring-after(substring-after(@xml:id,'-'),'-')}.xhtml#{substring-after(substring-after(@xml:id,'-'),'-')}">
										<xsl:value-of select="db:info/db:title"/>
									</a>
								</li>
							</xsl:for-each>
							<xsl:variable name="chapid">
								<xsl:value-of select="//db:abbreviation/following-sibling::*[1][local-name()='part' or local-name()='chapter']/@xml:id|//db:preface/following-sibling::*[1][local-name()='part' or local-name()='chapter']/@xml:id|//db:acknowledgements/following-sibling::*[1][local-name()='part' or local-name()='chapter']/@xml:id"/>
							</xsl:variable>
							<li><a epub:type="bodymatter" href="{substring-after(substring-after( $chapid,'-'),'-')}.xhtml#part1">Start of Content</a></li>		
							<xsl:for-each select="//db:chapter[contains(@xml:id, 'conc') or contains(@xml:id, 'index') or contains(@xml:id, 'appendix')]">
								<li>
									<a epub:type="backmatter"  href="{substring-after(substring-after(@xml:id,'-'),'-')}.xhtml#{substring-after(substring-after(@xml:id,'-'),'-')}"><xsl:value-of select="db:info/db:title"/></a>
								</li>
							</xsl:for-each>
							<li><a epub:type="index" href="index.xhtml#index">Index</a></li>
						</ol>
					</nav>
					<nav epub:type="page-list" role="doc-pagelist" hidden="" aria-label="page list">
						<ol class="none">
							<li><a href="halftitle.xhtml#page_i">i</a></li>
							<li><a href="series.xhtml#page_ii">ii</a></li>
							<li><a href="title.xhtml#page_iii">iii</a></li>
							<li><a href="copyright.xhtml#page_iv">iv</a></li>
							<li><a href="dedication.xhtml#page_v">v</a></li>
							<li><a href="dedication.xhtml#page_vi">vi</a></li>
							<li><a href="contents.xhtml#page_vii">vii</a></li>
							<li><a href="Preface.xhtml#page_viii">viii</a></li>
							<li><a href="Preface.xhtml#page_ix">ix</a></li>
							<li><a href="ack.xhtml#page_x">x</a></li>
							<li><a href="intro.xhtml#page_1">1</a></li>
							<li><a href="intro.xhtml#page_2">2</a></li>
							<li><a href="intro.xhtml#page_3">3</a></li>
							<li><a href="intro.xhtml#page_4">4</a></li>
							<li><a href="intro.xhtml#page_5">5</a></li>
							<li><a href="intro.xhtml#page_6">6</a></li>
							<li><a href="intro.xhtml#page_7">7</a></li>
							<li><a href="intro.xhtml#page_8">8</a></li>
							<li><a href="intro.xhtml#page_9">9</a></li>
							<li><a href="intro.xhtml#page_10">10</a></li>
							<li><a href="intro.xhtml#page_11">11</a></li>
							<li><a href="intro.xhtml#page_12">12</a></li>
							<li><a href="intro.xhtml#page_13">13</a></li>
							<li><a href="conc.xhtml#page_181">181</a></li>
							<li><a href="conc.xhtml#page_182">182</a></li>
							<li><a href="conc.xhtml#page_183">183</a></li>
							<li><a href="conc.xhtml#page_184">184</a></li>
							<li><a href="conc.xhtml#page_185">185</a></li>
							<li><a href="conc.xhtml#page_186">186</a></li>
							<li><a href="app.xhtml#page_187">187</a></li>
							<li><a href="app.xhtml#page_188">188</a></li>
							<li><a href="index.xhtml#page_189">189</a></li>
							<li><a href="index.xhtml#page_190">190</a></li>
							<li><a href="index.xhtml#page_191">191</a></li>
							<li><a href="index.xhtml#page_192">192</a></li>
							<li><a href="index.xhtml#page_193">193</a></li>
							<li><a href="index.xhtml#page_194">194</a></li>
							<li><a href="index.xhtml#page_195">195</a></li>
							<li><a href="index.xhtml#page_196">196</a></li>
							<li><a href="index.xhtml#page_196">197</a></li>
							<li><a href="index.xhtml#page_196">198</a></li>
							<li><a href="index.xhtml#page_196">199</a></li>
							<li><a href="index.xhtml#page_196">200</a></li>
						</ol>
					</nav>
				</body>
			</html>
		...
		<xsl:result-document href="{translate($bid,'-','')}/OEBPS/xhtml/contents.xhtml" method="xml" indent="yes" use-character-maps="hex">
			...
			<html xmlns="http://www.w3.org/1999/xhtml" xmlns:epub="http://www.idpf.org/2007/ops" xml:lang="en" lang="en">
				...
				<body epub:type="frontmatter">
					<section epub:type="toc" role="doc-toc" id="re_contents">
						<h1 epub:type="title" class="FMT">Contents</h1>
					...
					<xsl:for-each select="//db:chapter[not(@role='notes' or contains(@xml:id, 'note'))]|//db:appendix|//db:part[child::db:label]">
						<p class="TOC-CH">
							<a href="{substring-after(substring-after(@xml:id,'-'),'-')}.xhtml#{substring-after(substring-after(@xml:id,'-'),'-')}">
								<xsl:value-of select="@label"/><xsl:value-of select="child::db:label"/>
								<xsl:text> </xsl:text>
								<xsl:apply-templates select="db:info/db:title" mode="toc"/>
								<xsl:if test="db:info/db:subtitle">
									<xsl:apply-templates select="db:info/db:subtitle" mode="toc"/>
						...
						<xsl:if test="db:section">
							<!--<xsl:if test="$toclevel=3">-->
								<xsl:for-each select=".//child::db:section">
									...
									<p class="TOC-CH-sec{$seclevel}">
										<xsl:apply-templates select="db:info/db:title" mode="toc"/>
									</p>
								</xsl:for-each>
								
								<!--<xsl:for-each select="db:section/db:section">
									<p class="TOC-CH-sec2" id="re_{@xml:id}">
										<xsl:apply-templates select="db:info/db:title" mode="toc"/>
									</p>
								</xsl:for-each>
								
								<xsl:for-each select="db:section/db:section/db:section">
									<p class="TOC-CH-sec3" id="re_{@xml:id}">
										<xsl:apply-templates select="db:info/db:title" mode="toc"/>
									</p>
								</xsl:for-each>-->
							<!--</xsl:if>-->
							<!--<xsl:if test="$toclevel=1">
								<xsl:for-each select="db:section">
									<p class="TOC-CH-sec" id="re_{@xml:id}">
										<xsl:apply-templates select="db:info/db:title" mode="toc"/>
									</p>
								</xsl:for-each>
							</xsl:if>
							...
							<xsl:if test="$toclevel=3">
								<xsl:for-each select="db:section|db:section/db:section|db:section/db:section/db:section">
									<p class="TOC-CH-sec" id="re_{@xml:id}">
										<xsl:apply-templates select="db:info/db:title" mode="toc"/>
									</p>
								</xsl:for-each>
		...
		<xsl:result-document href="{translate($bid,'-','')}/OEBPS/content.opf" method="xml" indent="yes" use-character-maps="hex">
			<package xmlns="http://www.idpf.org/2007/opf" version="3.0" unique-identifier="p{translate($bid,'-','')}" xml:lang="en">
				<metadata xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:opf="http://www.idpf.org/2007/opf">
					<dc:identifier id="p{translate($bid,'-','')}"><xsl:value-of select="concat('URN:ISBN:',translate($bid,'-',''))"/></dc:identifier>
					<dc:source id="pgsrc"><xsl:value-of select="translate($bid,'-','')"/></dc:source>
					<dc:relation id="hbk"><xsl:value-of select="translate(//db:biblioid[@role='hardback'],'-','')"/></dc:relation>
					<dc:relation id="pbk"><xsl:value-of select="translate(//db:biblioid[@role='paperback'],'-','')"/></dc:relation>
					<dc:relation id="ebk"><xsl:value-of select="translate(//db:biblioid[@role='epub'],'-','')"/></dc:relation>
					<dc:title>
					...
					<dc:creator>
						<xsl:apply-templates select="db:book/db:info/db:info/db:authorgroup" mode="opf"/>
					</dc:creator>
					<dc:publisher>
						<xsl:value-of select="substring-after(//db:biblioset[@role='publisher']/db:phrase[@first],'by ')"/>
					</dc:publisher>
					<dc:rights><xsl:value-of select="//db:copyright/db:holder"/></dc:rights>
					<dc:date><xsl:value-of select="format-date(current-date(), '[Y0001]-[M01]-[D01]')"/></dc:date>
					<dc:description><xsl:value-of select="db:book/db:abstract[@abstract-type='blurb']"/></dc:description>
					
					<meta refines="#pgsrc" property="source-of">pagination</meta>
					...
					<xsl:choose>
						<!--<xsl:when test="db:book//db:figure//db:imagedata/@alt[.!='']">
							<meta property="schema:accessibilitySummary"><xsl:value-of select="db:book/db:info/db:title"/> contains print page numbers, reading order, structural navigation, table of contents, index page-list, and alt text for all images.</meta>		
						</xsl:when>-->
						<xsl:when test="count(//db:figure)=0 and count(//db:table)=0">
							<meta property="schema:accessibilitySummary"><xsl:value-of select="db:book/db:info/db:title"/> is a simple book with footnotes, lists, and formatting defined with structural markup. This book contains accessibility features such as a table of contents, print page numbers, landmarks, reading order, structural navigation, index, semantic structure, in-text links, and backlinks. All in-text citations are linked, however backlinks only return to their first in-text citation. Linked DOIs are provided, but are not uniquely identified.</meta>
						</xsl:when>
						<xsl:when test="count(//db:figure)&gt;0 and count(//db:table)&gt;0">
							<meta property="schema:accessibilitySummary"><xsl:value-of select="db:book/db:info/db:title"/> is a Moderate book with several lists, a few tables, some figures, and lots of links with structural markup. This book contains accessibility features such as a contains print page numbers, reading order, structural navigation, table of contents, index page-list, MathML, semantic structure, in-text links, and backlinks. All in-text citations are linked, however backlinks only return to their first in-text citation. Linked DOIs are provided, but are not uniquely identified.</meta>
						</xsl:when>
						<xsl:when test="count(//db:figure)&gt;0 and count(//db:table)&gt;30 and count(//table[@class='equation'])&gt;0">
							<meta property="schema:accessibilitySummary"><xsl:value-of select="db:book/db:info/db:title"/> is a Complex book with footnotes, several lists, tables, figures, MathML, and lots of links with structural markup. This book contains accessibility features such as a contains print page numbers, reading order, structural navigation, table of contents, index page-list, MathML, semantic structure, in-text links, and backlinks. All in-text citations are linked, however backlinks only return to their first in-text citation. Linked DOIs are provided, but are not uniquely identified.</meta>
						</xsl:when>
						<xsl:otherwise>
							<meta property="schema:accessibilitySummary"><xsl:value-of select="db:book/db:info/db:title"/> is a simple book with formatting defined with structural markup. This book contains accessibility features such as a table of contents, landmarks, reading order, structural navigation, index, semantic structure, in-text links, and backlinks. All in-text citations are linked, however backlinks only return to their first in-text citation. Linked DOIs are provided, but are not uniquely identified.</meta>
						</xsl:otherwise>
					</xsl:choose>
		...
		<!--<xsl:result-document href="{translate($bid,'-','')}/OEBPS/oebps-page-map.xml" method="xml" indent="yes" use-character-maps="hex">
			
			<page-map xmlns="http://www.idpf.org/2007/opf">
				
				
				<page name="i" href="xhtml/halftitle.xhtml#page_i"/>
				<page name="ii" href="xhtml/series.xhtml#page_ii"/>
				<page name="iii" href="xhtml/title.xhtml#page_iii"/>
				<page name="iv" href="xhtml/copyright.xhtml#page_iv"/>
				<page name="v" href="xhtml/dedication.xhtml#page_v"/>
				<page name="vi" href="xhtml/dedication.xhtml#page_vi"/>
				<page name="vii" href="xhtml/contents.xhtml#page_vii"/>
				<page name="viii" href="xhtml/Preface.xhtml#page_viii"/>
				<page name="ix" href="xhtml/Preface.xhtml#page_ix"/>
				<page name="x" href="xhtml/ack.xhtml#page_x"/>
				<page name="1" href="xhtml/intro.xhtml#page_1"/>
				<page name="2" href="xhtml/intro.xhtml#page_2"/>
				<page name="3" href="xhtml/intro.xhtml#page_3"/>
				<page name="4" href="xhtml/intro.xhtml#page_4"/>
				<page name="5" href="xhtml/intro.xhtml#page_5"/>
				<page name="6" href="xhtml/intro.xhtml#page_6"/>
				<page name="7" href="xhtml/intro.xhtml#page_7"/>
				<page name="8" href="xhtml/intro.xhtml#page_8"/>
				<page name="9" href="xhtml/intro.xhtml#page_9"/>
				<page name="10" href="xhtml/intro.xhtml#page_10"/>
				<page name="11" href="xhtml/intro.xhtml#page_11"/>
				<page name="12" href="xhtml/intro.xhtml#page_12"/>
				<page name="13" href="xhtml/intro.xhtml#page_13"/>
				<page name="14" href="xhtml/intro.xhtml#page_14"/>
				<page name="15" href="xhtml/intro.xhtml#page_15"/>
				<page name="16" href="xhtml/ch1.xhtml#page_16"/>
				<page name="17" href="xhtml/ch1.xhtml#page_17"/>
				<page name="18" href="xhtml/ch1.xhtml#page_18"/>
				<page name="19" href="xhtml/ch1.xhtml#page_19"/>
				<page name="20" href="xhtml/ch1.xhtml#page_20"/>
				<page name="21" href="xhtml/ch1.xhtml#page_21"/>
				<page name="22" href="xhtml/ch1.xhtml#page_22"/>
				<page name="23" href="xhtml/ch1.xhtml#page_23"/>
				<page name="24" href="xhtml/ch1.xhtml#page_24"/>
				<page name="25" href="xhtml/ch1.xhtml#page_25"/>
				<page name="26" href="xhtml/ch1.xhtml#page_26"/>
				<page name="27" href="xhtml/ch1.xhtml#page_27"/>
				<page name="28" href="xhtml/ch1.xhtml#page_28"/>
				<page name="180" href="xhtml/conc.xhtml#page_180"/>
				<page name="181" href="xhtml/conc.xhtml#page_181"/>
				<page name="182" href="xhtml/conc.xhtml#page_182"/>
				<page name="183" href="xhtml/conc.xhtml#page_183"/>
				<page name="184" href="xhtml/conc.xhtml#page_184"/>
				<page name="185" href="xhtml/conc.xhtml#page_185"/>
				<page name="186" href="xhtml/conc.xhtml#page_186"/>
				<page name="187" href="xhtml/app.xhtml#page_187"/>
				<page name="188" href="xhtml/app.xhtml#page_188"/>
				<page name="189" href="xhtml/index.xhtml#page_189"/>
				<page name="190" href="xhtml/index.xhtml#page_190"/>
				<page name="191" href="xhtml/index.xhtml#page_191"/>
				<page name="192" href="xhtml/index.xhtml#page_192"/>
				<page name="193" href="xhtml/index.xhtml#page_193"/>
				<page name="194" href="xhtml/index.xhtml#page_194"/>
				<page name="195" href="xhtml/index.xhtml#page_195"/>
				<page name="196" href="xhtml/index.xhtml#page_196"/>
				<page name="196" href="xhtml/index.xhtml#page_197"/>
				<page name="196" href="xhtml/index.xhtml#page_198"/>
				<page name="196" href="xhtml/index.xhtml#page_199"/>
				<page name="196" href="xhtml/index.xhtml#page_200"/>
	...
	<xsl:template match="db:chapter[not(@role='notes' or contains(@xml:id, 'note'))]|db:appendix|db:part">
					...
					<body epub:type="bodymatter">
						...
						<xsl:variable name="chaprole">
							<xsl:choose>
								...
								<xsl:when test="contains($chapid,'appendix')">appendix</xsl:when>
								<xsl:otherwise>chapter</xsl:otherwise>
							</xsl:choose>
						</xsl:variable>
						
						<section epub:type="{$chaprole}" role="doc-{$chaprole}">
							<xsl:apply-templates select="node() except (db:remark,db:minitoc,db:info[child::db:author],db:bibliography)" />
	...
	<xsl:template match="db:chapter/db:info[db:title]|db:appendix/db:info">
		<header>
			<h1 id="{substring-after(substring-after((ancestor::db:chapter|ancestor::db:appendix)/@xml:id,'-'),'-')}">
						<!--<xsl:choose>
							<xsl:when test=".//parent::db:info/parent::db:chapter/@label">
								<xsl:apply-templates select="processing-instruction('page')"/>
						<xsl:value-of select=".//parent::db:info/parent::db:chapter/@label"/><xsl:text disable-output-escaping="yes"> </xsl:text><xsl:apply-templates select="./db:title"/>
						<xsl:if test="./child::db:subtitle">
							<span epub:type="subtitle" role="doc-subtitle" class="cn">
								<xsl:apply-templates select="./child::db:subtitle"/>
							</span>	
						</xsl:if>
							</xsl:when>
							<xsl:otherwise>
								<xsl:apply-templates select="node() except (db:footnote,db:subtitle)"/>
							</xsl:otherwise>
							</xsl:choose>-->
				<xsl:apply-templates select="processing-instruction('page')"/>
				<xsl:if test=".//parent::db:info/parent::db:chapter/@label">
					<xsl:value-of select=".//parent::db:info/parent::db:chapter/@label"/><xsl:text disable-output-escaping="yes"> </xsl:text>	
				</xsl:if>
			...
			<xsl:if test="./preceding-sibling::db:remark">
				<p class="doi">
					<xsl:text>DOI: </xsl:text><a aria-label="D.O.I. link to this document." href="{concat('https://doi.org/',./preceding-sibling::db:remark)}"><xsl:apply-templates select="./preceding-sibling::db:remark"/></a>
				</p>	
			</xsl:if>
			<xsl:apply-templates select="./following-sibling::db:minitoc"/>
		</header>
	</xsl:template>
	...
	<xsl:template match="db:part[child::db:label]/db:info/db:title">
		<xsl:if test="./ancestor::db:part/child::db:label">
			<h1 class="PN" id="{substring-after(substring-after(ancestor::db:part/@xml:id,'-'),'-')}">
				<xsl:apply-templates select="processing-instruction()"/>
				<xsl:value-of select="./ancestor::db:part/child::db:label"/><xsl:text disable-output-escaping="yes"> </xsl:text><xsl:apply-templates select="node() except (processing-instruction(),db:footnote)"/>
			</h1>
		</xsl:if>
	</xsl:template>
	...
	<xsl:template match="db:chapter/db:info/db:title|db:part/db:info/db:title|db:appendix/db:info/db:title" mode="toc">
		<xsl:text> </xsl:text>
	...
	<xsl:template match="db:epigraph/db:para">
		<xsl:choose>
			<xsl:when test="count(./child::node())=1 and ./child::node()[local-name()='informalfigure']">
				<figure class="EPG">
					<xsl:apply-templates/>
				</figure>
			</xsl:when>
	...
	<xsl:template match="processing-instruction('page')" mode="#all">
		<span epub:type="pagebreak" role="doc-pagebreak" aria-label=" {concat('page ',substring-before(substring-after(.,'value=&quot;'),'&quot;'))}. " id="{concat('p',substring-before(substring-after(.,'value=&quot;'),'&quot;'))}"/>
	</xsl:template>
	
	<xsl:template match="processing-instruction('page1')" mode="#all">
		<span epub:type="pagebreak" role="doc-pagebreak" aria-label=" {concat(concat('page ',substring-before(substring-after(.,'value=&quot;'),'&quot;')),' is blank')}. " id="{concat('p',substring-before(substring-after(.,'value=&quot;'),'&quot;'))}"/>
	</xsl:template>
	...
	<xsl:template match="db:para">
		<xsl:choose>
			...
			<xsl:when test="./parent::db:footnote[@role='end-bk-note']">
				<xsl:apply-templates/>
			</xsl:when>
			<xsl:when test="./parent::db:sidebar">
				<p class="TXT">
					<xsl:apply-templates/>
				</p>
			</xsl:when>
	...
	<xsl:template match="db:emphasis">
		<xsl:choose>
			<xsl:when test="@role='italic'">
				<xsl:choose>
					<xsl:when test="./parent::db:title and (./ancestor::db:bibliomset or ./ancestor::db:bibliomixed)">
						<i><xsl:apply-templates/></i>
					</xsl:when>
					<xsl:when test="./parent::db:bibliomixed">
						<i><xsl:apply-templates/></i>
					</xsl:when>
					<xsl:when test="./parent::db:title_cite">
						<xsl:apply-templates/>
					</xsl:when>
					<xsl:otherwise>
						<i><xsl:apply-templates/></i>		
	...
	<xsl:template match="db:footnote[@role='end-bk1-note']">
		<sup>
			<a href="{concat('notes.xhtml#', substring-after(substring-after(ancestor::db:chapter/@xml:id,'-'),'-'),'_f-',@label)}" id="{concat('re_f-',@label)}">
				<xsl:value-of select="@label"/>
			</a>
		</sup>
		<xsl:apply-templates/>
	...
	<xsl:template match="db:section">
		<xsl:variable name="full_title" select="string-join(./db:info/db:title/node()[not(self::comments)], '')" />
		<xsl:choose>
			<xsl:when test="matches($full_title,'introduction','i')">
				<section epub:type="introduction" role="doc-introduction">
					<xsl:apply-templates/>
				</section>
			</xsl:when>
			<xsl:when test="matches($full_title,'acknowledgement','i')">
			...
			<xsl:when test="matches($full_title,'conclusion','i')">
	...
	<xsl:template match="db:subscript" mode="index">
		<span class="subscript">
			<xsl:apply-templates/>
		</span>
	</xsl:template>
	
	<xsl:template match="db:term" mode="index">
		<span class="term"><xsl:apply-templates mode="index"/></span>
	</xsl:template>
	...
	<xsl:template match="db:primary" mode="index">
		<li epub:type="index-entry">
			...
			<xsl:apply-templates select="node() except (db:indexterm[parent::db:primary])" mode="index"/>
	...
	<xsl:template match="db:figure" mode="#all">
		<figure id="{translate(substring-before(substring-after(./db:mediaobject/db:imageobject/db:imagedata/@fileref,'/'),'.jpg'),'fig','f')}">
			...
			<figcaption>
				<p>
					<a href="{concat(concat(substring-after(substring-after(ancestor::db:chapter/@xml:id, '-'),'-'),'.xhtml#re_'),translate(substring-before(substring-after(./db:mediaobject/db:imageobject/db:imagedata/@fileref,'/'),'.jpg'),'fig','f'))}">
						<i><span epub:type="label">
							<xsl:value-of select="./db:label"/>
						</span>
						<span epub:type="ordinal">
							<xsl:value-of select="./db:fignum"/>
						</span></i>
					</a>
	...
	<xsl:template match="db:book/db:info/db:info/db:authorgroup" mode="opf">
		<xsl:apply-templates select="node() except processing-instruction('page')"/>
	</xsl:template>
	<xsl:template match="db:book/db:info/db:title">
		<xsl:result-document href="{translate($bid,'-','')}/OEBPS/xhtml/title.xhtml" method="xml" use-character-maps="hex" indent="yes">
			...
			<html xmlns="http://www.w3.org/1999/xhtml" xmlns:epub="http://www.idpf.org/2007/ops" xml:lang="en" lang="en">
				...
				<body epub:type="frontmatter">
					...
					<p class="Book-Author">
						<xsl:apply-templates select="./parent::db:info/db:info/db:authorgroup"/>
					</p>
					<xsl:choose>
						<xsl:when test="./ancestor::db:book[@client='hss']">
							<figure class="PUB"><img src="../images/logo.jpg" alt="Logo: Published by Routledge, Taylor and Francis Group."/></figure>	
						</xsl:when>
						<xsl:otherwise>
							<figure class="PUB"><img src="../images/logo.jpg" alt="Logo: Published by C R C Press, Taylor and Francis Group, Boca Raton, London, New York; C R C Press is an imprint of Taylor and Francis Group, an informa business."/></figure>
						</xsl:otherwise>
					</xsl:choose>
						
					<!--26-07-2021-->
					<!--<p class="EDI">
						<xsl:value-of select="parent::db:info/db:edition"/>
					</p>-->
					<!--<p class="IMP">-->
						<xsl:apply-templates select="parent::db:info/db:bibliomisc[@role='imprint']"/>
					<!--</p>-->
					<xsl:if test="parent::db:info/db:biblioset[@role='publisher']/db:publisher">
						<figure class="PUB">
							<img src="../images/logo.jpg" alt="Logo: Published by {.//db:bibliomisc[@role='imprint']}"/>
						</figure>
						<!--<p class="PUB">
							<xsl:apply-templates select="parent::db:info/db:biblioset[@role='publisher']/db:publisher"/>
						</p>-->		
					</xsl:if>
		...
		<xsl:result-document href="{translate($bid,'-','')}/OEBPS/xhtml/halftitle.xhtml" method="xml" use-character-maps="hex" indent="yes">
			...
			<html xmlns="http://www.w3.org/1999/xhtml" xmlns:epub="http://www.idpf.org/2007/ops" xml:lang="en" lang="en">
				...
				<body epub:type="frontmatter">
					<section epub:type="halftitlepage" aria-label="half title page">
			...
			<html xmlns="http://www.w3.org/1999/xhtml" xmlns:epub="http://www.idpf.org/2007/ops" xml:lang="en" lang="en">
				...
				<body epub:type="frontmatter">
					...
					<xsl:choose>
						...
						<xsl:text>&#xa;</xsl:text>
						<h1 id="{substring-after(substring-after(@xml:id,'-'),'-')}" class="FMT"><xsl:value-of select="db:info/db:title"/></h1>
					<xsl:apply-templates select="node() except (db:title)"/>
					<xsl:if test="descendant::db:footnote[@role='end-bk-note']">
	...
	<xsl:template match="db:acknowledgements/db:info/db:title">
		<h1 id="ack" class="FMT"><xsl:apply-templates select="processing-instruction('page')"/><xsl:value-of select="."/></h1>
	</xsl:template>
	...
	<xsl:template match="db:glossary/db:info/db:title">
		<h1 id="glossary" class="FMT"><xsl:value-of select="."/></h1>
	</xsl:template>
	...
	<xsl:template match="db:dedication">
		<xsl:result-document href="{translate($bid,'-','')}/OEBPS/xhtml/dedication.xhtml" method="xml" use-character-maps="hex" indent="yes">
			...
			<html xmlns="http://www.w3.org/1999/xhtml" xmlns:epub="http://www.idpf.org/2007/ops" xml:lang="en" lang="en">
				...
				<body epub:type="frontmatter">
					<section epub:type="dedication" role="doc-dedication" aria-label="dedication page">
		...
		<xsl:result-document href="{translate($bid,'-','')}/OEBPS/xhtml/copyright.xhtml" method="xml" use-character-maps="hex" indent="yes">
			...
			<html xmlns="http://www.w3.org/1999/xhtml" xmlns:epub="http://www.idpf.org/2007/ops" xml:lang="en" lang="en">
				...
				<body epub:type="frontmatter">
					...
					<p class="CT">
						<a id="copy">Copyright</a>
					</p>
					<p class="Copy-TXT">&amp;#x00A9; <xsl:apply-templates/>
					</p>
						<xsl:apply-templates select="following-sibling::db:legalnotice/db:para|following-sibling::db:biblioset[@role='isbns']/db:biblioid|preceding-sibling::db:biblioset|preceding-sibling::db:edition|preceding-sibling::db:pubdate"/>
					</section>
				</body>
			</html>
		</xsl:result-document>
...
<!--	<xsl:template match="db:table">
	...
	<xsl:template match="db:table" mode="#all">
		...
		<table>
			<xsl:choose>
				<xsl:when test="./@role">
					<xsl:attribute name="id"><xsl:value-of select="translate(@xml:id,'T','t')"/></xsl:attribute>
					<xsl:attribute name="class">TABL</xsl:attribute>	
				</xsl:when>
				<xsl:otherwise>
					<xsl:attribute name="class">TABL1</xsl:attribute>
				</xsl:otherwise>
			</xsl:choose>
			<xsl:if test="not (@class) and @role='inline' or @role='float'">
				<caption>
					<a href="{concat(concat((substring-after(substring-after(ancestor::db:chapter/@xml:id, '-'),'-')),'.xhtml#re_'),translate(@xml:id,'T','t'))}">
						<b>
							<span epub:type="label"><xsl:value-of select="./db:label"/></span><xsl:text disable-output-escaping="yes"> </xsl:text>
							<span epub:type="ordinal"><xsl:value-of select="./db:fignum"/></span>
						</b>
					</a> 
					<xsl:apply-templates select="./child::db:info/db:title"/>
				</caption>
			</xsl:if>
			<xsl:apply-templates select="node() except (./child::db:label,./child::db:info/db:title,./db:fignum)"/>
		</table>
	</xsl:template>
...
<!--<xsl:template match="db:itemizedlist">
	...
	<xsl:template match="db:itemizedlist/db:listitem/db:para">
	...
	<xsl:template match="db:orderedlist/db:listitem" mode="withstart">
		<li>
			<xsl:apply-templates select="node() except db:token"/>
		</li>		
	</xsl:template>
	...
	<xsl:template match="db:orderedlist/db:listitem/db:para" mode="withoutstart">
		<li>
			<xsl:value-of select="db:token"/><xsl:text disable-output-escaping="yes"> </xsl:text> <xsl:apply-templates select="node() except db:token"/>
		</li>
	</xsl:template>
	...
	<xsl:template match="db:itemizedlist[not (@mark)]">
		<ul class="ul-1">
			<xsl:apply-templates/>
		</ul>
	</xsl:template>
...
-->
	<xsl:template match="db:link[@role='figure']">
		<xsl:choose>
			<xsl:when test="./@index">
				<a id="re_{translate(substring-before(substring-after(key('images', @linkend)/db:mediaobject/db:imageobject/db:imagedata/@fileref,'/'),'.jpg'),'fig','f')}" href="{substring-after(substring-after(key('images', @linkend)/(ancestor::db:chapter|ancestor::db:appendix|ancestor::db:part[@label])/@xml:id,'-'),'-')}.xhtml#{translate(substring-before(substring-after(key('images', @linkend)/db:mediaobject/db:imageobject/db:imagedata/@fileref,'/'),'.jpg'),'fig','f')}">
					<xsl:apply-templates/>
				</a>
			</xsl:when>
			<xsl:otherwise>
				<a href="{substring-after(substring-after(key('images', @linkend)/(ancestor::db:chapter|ancestor::db:appendix|ancestor::db:part[@label])/@xml:id,'-'),'-')}.xhtml#{translate(substring-before(substring-after(key('images', @linkend)/db:mediaobject/db:imageobject/db:imagedata/@fileref,'/'),'.jpg'),'fig','f')}">
					<xsl:apply-templates/>
				</a>		
			</xsl:otherwise>
		</xsl:choose>
	...
	<xsl:template match="db:link[@role='chapter']">
		<a href="{concat(concat(./@linkend,'.xhtml#'),./@linkend)}">
			<xsl:apply-templates/>
		</a>
	</xsl:template>
	...
	<xsl:template match="db:link[@role='table']">
		<xsl:choose>
			<xsl:when test="./@index">
				<a id="re_{translate(key('images', @linkend)/@xml:id,'T','t')}" href="{substring-after(substring-after(key('images', @linkend)/(ancestor::db:chapter|ancestor::db:appendix|ancestor::db:part[@label])/@xml:id,'-'),'-')}.xhtml#{translate(key('images', @linkend)/@xml:id,'T','t')}">
					<xsl:apply-templates/>
				</a>
			</xsl:when>
			<xsl:otherwise>
				<a href="{substring-after(substring-after(key('images', @linkend)/(ancestor::db:chapter|ancestor::db:appendix|ancestor::db:part[@label])/@xml:id,'-'),'-')}.xhtml#{translate(key('images', @linkend)/@xml:id,'T','t')}">
					<xsl:apply-templates/>
				</a>		
			</xsl:otherwise>
		</xsl:choose>
...
<!--	<xsl:template match="db:link[@role='bibr']">
		...
		<a>
			<xsl:choose>
				...
				<xsl:when test="./@linkend">
					...
					<xsl:attribute name="id"><xsl:value-of select="./@linkend"/></xsl:attribute>
				</xsl:when>
			</xsl:choose>
			<xsl:apply-templates/>
		</a>
	...
	<xsl:template match="db:link[@role='page']" mode="index">
		<a epub:type="index-locator"><xsl:attribute name="href"><xsl:value-of select="./@href"></xsl:value-of></xsl:attribute><xsl:apply-templates/></a>
	</xsl:template>
	...
	<xsl:template match="db:footnote[@role='end-bk1-note']/db:para" mode="note">
			...
			<xsl:if test="not(preceding-sibling::db:para)">
				<xsl:choose>
					<xsl:when test="(ancestor::db:chapter|ancestor::db:appendix|ancestor::db:preface)/@xml:id">
						<a href="{concat(substring-after(substring-after((ancestor::db:chapter|ancestor::db:appendix|ancestor::db:preface)/@xml:id,'-'),'-'),'.xhtml#fnt-',parent::db:footnote/@label)}" id="{concat(substring-after(substring-after((ancestor::db:chapter|ancestor::db:appendix|ancestor::db:preface)/@xml:id,'-'),'-'),'_fn-',parent::db:footnote/@label)}">
							<b>
								<xsl:value-of select="parent::db:footnote/@label"/>
								<xsl:text>. </xsl:text>
							</b>
						</a>
					</xsl:when>
					<xsl:otherwise>
						<a href="{concat(substring-after(substring-after((ancestor::db:part[@label])/@xml:id,'-'),'-'),'.xhtml#fnt-',parent::db:footnote/@label)}" id="{concat(substring-after(substring-after((ancestor::db:part[@label])/@xml:id,'-'),'-'),'_fn-',parent::db:footnote/@label)}">
							<b>
								<xsl:value-of select="parent::db:footnote/@label"/>
								<xsl:text>. </xsl:text>
							</b>
	...
	<xsl:template match="db:footnote[@role='end-bk-note']">
		<sup>
			<a epub:type="noteref" role="doc-noteref" href="{concat('#',concat(substring-after(substring-after((ancestor::db:part[child::db:label])/@xml:id,'-'),'-'),'n-',@id))}" id="{concat('re_n-',@id)}">
				<xsl:value-of select="@label"/>
			</a>
		</sup>
	</xsl:template>
			
	<xsl:template match="db:ftlinkcot">
		<a epub:type="backlink" role="doc-backlink" aria-label=" This link returns to its first in-text citation. " href="{concat('#re_n-',./ancestor::db:footnote/@id)}">
			<xsl:apply-templates select="./node()"/>		
		</a>
	</xsl:template>		
	<xsl:template match="db:footnote[@role='end-bk-note']" mode="cnote">
		<li epub:type="endnote" id="{concat('n-',./@id)}">
			<xsl:choose>
	...
	<!--<xsl:template match="db:footnote[@role='end-bk-note']/child::node()" mode="cnote">
		<xsl:if test="not(preceding-sibling::db:para)">
			...
			<xsl:choose>
				<xsl:when test="(ancestor::db:chapter|ancestor::db:appendix|ancestor::db:preface)/@xml:id">
					<a epub:type="backlink" role="doc-backlink" aria-label=" This link returns to its first in-text citation. " href="{concat('#re_n-',parent::db:footnote/@id)}">
					<!-\-<a href="{concat(substring-after(substring-after((ancestor::db:chapter|ancestor::db:appendix|ancestor::db:preface)/@xml:id,'-'),'-'),'.xhtml#fnt-',parent::db:footnote/@id)}" id="{concat(substring-after(substring-after((ancestor::db:chapter|ancestor::db:appendix|ancestor::db:preface)/@xml:id,'-'),'-'),'_fn-',parent::db:footnote/@id)}">-\->
						<xsl:choose>
							<xsl:when test="parent::db:footnote/@ftlinkcot">
								<xsl:value-of select="parent::db:footnote/@ftlinkcot"/>		
							</xsl:when>
							<xsl:when test="parent::db:footnote/@ftlinkcot1">
								<i>
								<xsl:value-of select="parent::db:footnote/@ftlinkcot1"/>
								</i>
							</xsl:when>
						</xsl:choose>
					</a>
				...
				<xsl:otherwise>
					<a epub:type="backlink" role="doc-backlink" href="{concat(substring-after(substring-after((ancestor::db:part[child::db:label])/@xml:id,'-'),'-'),'.xhtml#re_n-',parent::db:footnote/@label)}" id="{concat(substring-after(substring-after((ancestor::db:part[child::db:label])/@xml:id,'-'),'-'),'n-',parent::db:footnote/@label)}">
						<xsl:choose>
							<xsl:when test="parent::db:footnote/@ftlinkcot">
								<xsl:value-of select="parent::db:footnote/@ftlinkcot"/>		
							</xsl:when>
	...
	<xsl:template match="db:bibliography[not(ancestor::db:chapter) and not(ancestor::db:preface)]">
			...
			<html xmlns="http://www.w3.org/1999/xhtml" xmlns:epub="http://www.idpf.org/2007/ops" xml:lang="en" lang="en">
				...
				<body epub:type="backmatter">
					<section epub:type="bibliography">
						<h1 id="bib" class="FMT"><xsl:value-of select="db:info/db:title"/></h1>
					<xsl:apply-templates/>
					</section>
				</body>
			</html>			
	...
	<xsl:template match="db:bibliomixed/db:biblink">
		<a href="#{./parent::db:bibliomixed/@xml:id}">
			<xsl:apply-templates/>
		</a>
	</xsl:template>
		
	<xsl:template match="db:bibliomixed">
		<li epub:type="biblioentry" class="Biblio" id="re_{./@xml:id}">
			<xsl:apply-templates/>
		</li>
	</xsl:template>
	...
	<xsl:template match="db:bibliography[not(ancestor::db:chapter)]/db:info/db:title|db:preface/db:info/db:title|db:footnote/db:blockquote|db:footnote[@role='end-bk1-note']/db:bibliolist/db:bibliomixed"/>
	...
	<xsl:template match="db:footnote[@role='end-bk1-note']/db:bibliolist/db:bibliomixed" mode="note">
		<aside epub:type="footnotes">
...
-->		</xsl:variable>
	...
	<xsl:template match="db:title_cite">
		<cite>
			<xsl:apply-templates/>
		</cite>
	</xsl:template>
	...
	<xsl:template match="db:link[@xlink:href]/db:uri">
		<xsl:choose>
			<xsl:when test="(matches(./@xlink:href,'doi.org')) and ./ancestor::db:bibliomixed and count(./ancestor::db:bibliomixed//db:title_cite)&gt;0 and count(./ancestor::db:bibliomixed/db:emphasis[@role='italic'])&gt;0">
				<a aria-label="{concat('D.O.I. link to ',./ancestor::db:bibliomixed//db:title_cite)}" href="{@xlink:href}">
					<xsl:apply-templates/>
				</a>
			</xsl:when>
			<xsl:when test="(matches(./@xlink:href,'doi.org')) and ./ancestor::db:bibliomixed and count(./ancestor::db:bibliomixed//db:title_cite)&gt;0 and count(./ancestor::db:bibliomixed/db:emphasis[@role='italic'])=0">
			...
			<xsl:when test="(matches(./@xlink:href,'doi.org')) and ./ancestor::db:bibliomixed and count(./ancestor::db:bibliomixed//db:title_cite)=0 and count(./ancestor::db:bibliomixed/db:emphasis[@role='italic'])&gt;0">
				<a aria-label="{concat('D.O.I. link to ',./ancestor::db:bibliomixed//db:emphasis[@role='italic'][0])}" href="{@xlink:href}">
					<xsl:apply-templates/>
				</a>
			</xsl:when>
			<xsl:when test="(matches(./@xlink:href,'doi.org')) and ./ancestor::db:bibliomixed and count(./ancestor::db:bibliomixed//db:title_cite)=0 and ./ancestor::db:bibliomixed and count(./ancestor::db:bibliomixed//db:title)&gt;0">
				<a aria-label="{concat('D.O.I. link to ',./ancestor::db:bibliomixed//db:title[0])}" href="{@xlink:href}">
					<xsl:apply-templates/>
				</a>
			</xsl:when>
			<xsl:otherwise>
	...
	<xsl:template match="db:indexterm|db:chapter[@role='notes' or contains(@xml:id,'note')]|db:footnote[@role='end-bk1-note']/db:para|db:dedication/db:info/db:title"/>	
